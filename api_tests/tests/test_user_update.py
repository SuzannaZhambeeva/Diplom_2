...
class TestUserUpdate:
    ...
    def test_user_update_name_with_auth(self, base_url, created_user):
    ...
    def test_user_update_email_with_auth(self, base_url, created_user):
    ...
    def test_user_update_password_with_auth(self, base_url, created_user):
